  ...
  return NextResponse.json(
    {
      ...
      faviconUrl: branded<string>('faviconUrl', '/branding/Nuwamail_Favicon.svg'),
      appLogoLightUrl: branded<string>('appLogoLightUrl', ''),
      appLogoDarkUrl: branded<string>('appLogoDarkUrl', ''),
      loginLogoLightUrl: branded<string>('loginLogoLightUrl', '/branding/Nuwamail_Logo_Color.svg'),
      loginLogoDarkUrl: branded<string>('loginLogoDarkUrl', '/branding/Nuwamail_Logo_White.svg'),
