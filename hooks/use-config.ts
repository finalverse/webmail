...
export function useConfig(): AppConfig {
  const [config, setConfig] = useState<AppConfig>({
    ...
    faviconUrl: configCache?.faviconUrl || '/branding/Nuwamail_Favicon.svg',
    appLogoLightUrl: configCache?.appLogoLightUrl || '',
    appLogoDarkUrl: configCache?.appLogoDarkUrl || '',
    loginLogoLightUrl: configCache?.loginLogoLightUrl || '/branding/Nuwamail_Logo_Color.svg',
    loginLogoDarkUrl: configCache?.loginLogoDarkUrl || '/branding/Nuwamail_Logo_White.svg',
